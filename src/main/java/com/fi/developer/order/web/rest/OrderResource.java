package com.fi.developer.order.web.rest;

import com.fi.developer.order.domain.Order;
import com.fi.developer.order.repository.OrderRepository;
import com.fi.developer.order.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.fi.developer.order.domain.Order}.
 */
@RestController
@RequestMapping("/api")
